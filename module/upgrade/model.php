 ...
 * @package     upgrade
 * @version     $Id: model.php 3507 2012-09-03 00:58:51Z shiyangyangwork@yahoo.cn $
...
class upgradeModel extends model
{
    ...
    public function getConfirm($fromVersion)
    {
        ...
        if($fromVersion == '0_3beta')
        {
            ...
            $confirmContent .= file_get_contents($this->getUpgradeFile('3.2'));
            $confirmContent .= file_get_contents($this->getUpgradeFile('3.2.1'));
        }
        elseif($fromVersion == '0_4beta')
        {
            $confirmContent .= file_get_contents($this->getUpgradeFile('0.4'));
     ...
     * @return void
     */
    public function upgradeFrom3_0_beta1To3_0_beta2()
    {
    ...
    /**
     * Upgrade from 3_0_beta2To3_0_stable 
     * 
     * @access public
     * @return void
     */
    public function upgradeFrom3_0_beta2To3_0_stable()
    {
        if(!$this->isError()) $this->setting->updateVersion('3.0.stable');
    }
     ...
     * @return void
     */
    public function upgradeFrom3_0To3_1()
    {
        if(!$this->isError()) $this->setting->updateVersion('3.1');
    }
     ...
     * @return void
     */
    public function upgradeFrom3_2To3_2_1()
    {
        $this->execSQL($this->getUpgradeFile('3.2'));
        if(!$this->isError()) $this->setting->updateVersion('3.2.1');
    }

    /**
     * Upgrade from 3.2.1 to 3.3.
     * 
     * @access public
     * @return void
     */
