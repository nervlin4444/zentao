...
<form method='post' target='hiddenwin'>
  <table align='center' class='table-4'> <?php //kevin add start?>
    <caption id='welcome'><?php echo $app->company->name;//printf($lang->welcome, $app->company->name);?></caption><?php //kevin add end?>
    <tr>
